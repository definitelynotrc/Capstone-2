...
<html lang="en">
  ...
  <body>
    ...
    <main
      class="lg:ml-52 md:ml-52 py-2 px-3 mx-auto flex flex-col gap-5 max-w-[1920px]"
    >
      <div class="w-full">
        ...
        <div class="w-full lg:w-[70%] flex flex-col gap-4">
          <div class="flex flex-col gap-2 w-full">
            <div class="w-full flex flex-row justify-between">
              <h1 class="text-2xl font-semibold">UI/UX Designer</h1>
              <button class="view rounded-md py-1 px-2 text-sm font-semibold">
                Assign student
              </button>
            </div>
            <div class="flex w-full items-center">
              <div class="w-full gap-4 flex flex-row items-center">
                <img
                  ...
                  alt=""
                  class="rounded-full w-[100px] h-full"
                />
                <ul class="flex flex-col gap-1">
                  <li class="flex flex-row items-center gap-1">
                    ...
                    <span class="font-light text-sm lg:text-xs">LinkedIn</span>
                  </li>
                  <li class="flex flex-row items-center gap-1">
                    <svg
                      width="16"
                    ...
                    <span class="font-light text-sm lg:text-xs"
          ...
          <div class="w-full">
            ...
            <textarea name="" id="" class="min-h-32 w-full overflow-auto">
Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis illo in ipsa exercitationem dignissimos neque ipsam, ex hic saepe commodi optio architecto laborum libero ducimus suscipit pariatur dolores dolorum odio!</textarea
            >
          </div>
          <div>
            <h1 class="font-semibold">Skills required</h1>
        ...
        <div
          class="flex flex-col lg:w-[30%] w-full overflow-y-auto max-h-screen"
        >
          <span class="font-semibold">Similar Jobs</span>
          <div class="w-full min-h-44 rounded-lg card flex flex-col gap-1 p-1">
            <div
              id=""
              class="colorCard flex flex-col gap-2 card p-2 rounded-md"
            >
