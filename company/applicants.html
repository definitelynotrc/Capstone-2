        ...
        <ul class="space-y-8 font-medium">
          ...
          <li>
            <a href="#" class="flex items-center p-2">
              ...
              <span class="ms-3">Job Posting</span>
            </a>
          </li>
          <li>
            <a href="#" class="flex items-center p-2">
          ...
          <li>
            <a href="#" class="flex items-center p-2">
              ...
              <span class="ms-3">Published Jobs</span>
            </a>
          </li>
        </ul>
        <div>
          ...
          >
            <div class="w-full flex flex-row gap-1">
              ...
              <div>
                ...
                <p class="text-[#7F7575] text-sm">SUM2021-01815</p>
                <p class="text-[#7F7575] text-sm">BSIT-4G</p>
              </div>
            </div>
            <div class="flex flex-wrap w-full gap-2">
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Front-End</p>
              </div>
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Back-End</p>
              </div>
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">MySQL</p>
              </div>
              <div
                class="bg-button h-6 rounded col-span-2 flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Communication</p>
              </div>
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Frameworks</p>
              </div>
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Fast Learner</p>
              </div>
              <div
                class="bg-button h-6 rounded flex items-center justify-center px-2"
              >
                <p class="text-center text-white text-[10px]">Node.js</p>
              </div>
            </div>
            <div class="flex flex-row justify-between">
              <button
                class="change-photo px-2 py-1 text-sm rounded-sm font-medium"
              >
                View profile</button
              ><button
                class="remove-photo px-2 py-1 rounded-sm text-sm font-medium"
              >
                Accept student
              </button>
            </div>
